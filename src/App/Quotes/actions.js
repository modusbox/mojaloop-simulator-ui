...
export const CHANGE_QUOTE_RESPONSE_CURRENCY = 'Quotes / change response currency';
...
export const changeQuoteResponseCurrency = createAction(CHANGE_QUOTE_RESPONSE_CURRENCY);
export const changeQuoteResponseReason = createAction(CHANGE_QUOTE_RESPONSE_REASON);
