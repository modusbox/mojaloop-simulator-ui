...
const ResponseBlock = ({ type = "regular", children }) => (
  <div
    className={`transfer__runner__response-block transfer__runner__response-block--${type}`}
  >
    {children}
  </div>
);
...
const ResponseItem = ({ label, path, data, small = false, split }) => {
  ...
  return (
    <div
      className={`transfer__runner__response-item ${
        small ? "transfer__runner__response-item--small" : ""
      }`}
    >
      ...
      <div className="transfer__runner__response-item-value">
        <div className="transfer__runner__response-item-value__content">
          <Tooltip label={tooltip || value} position="right">
            {value}
          </Tooltip>
        </div>
      </div>
        ...
        <div id="transfe__response">
          ...
          <ResponseBlock type="regular">
            <ResponseRow title="Quote">
              <ResponseItem
                label="Payee FSP Fee Amount"
                path="quoteResponse.payeeFspFee.amount"
                data={data}
              />
              <ResponseItem
                label="Payee FSP Fee Currency"
                path="quoteResponse.payeeFspFee.currency"
                data={data}
              />
            </ResponseRow>
            ...
            <ResponseRow>
              <ResponseItem
                label="Quote Amount"
                path="quoteResponse.transferAmount.amount"
                data={data}
              />
              <ResponseItem
                label="Quote Currency"
                path="quoteResponse.transferAmount.currency"
                data={data}
              />
            </ResponseRow>
            ...
            <ResponseRow>
              <ResponseItem
                label="Payee FSP Commission"
                path="quoteResponse.payeeFspCommission.amount"
                data={data}
              />
              <ResponseItem
                label="Payee FSP Commission"
                path="quoteResponse.payeeFspCommission.currency"
                data={data}
              />
            </ResponseRow>
